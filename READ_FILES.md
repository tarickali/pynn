...
**47 commits**, 2024-08-29 to 2026-08-08.

Current as of `44e094a`. Generated by
...
- [Era 5 — environment and packaging](#era-5--environment-and-packaging) — 23 commits (742f92a … 44e094a)
...
|---:|---|
| 16 | `README.md` |
| 11 | `pynn/core/tensor.py` |
| 10 | `READ_FILES.md` |
| 10 | `pyproject.toml` |
| 9 | `USAGE.md` |
| 9 | `pynn/verify/invariants.py` |
| 8 | `pynn/functional/modules.py` |
| 8 | `pynn/nn/__init__.py` |
| 7 | `.github/workflows/ci.yml` |
| 7 | `pynn/core/module.py` |
| 7 | `pynn/functional/activations.py` |
| 6 | `PROJECT_REVIEW.md` |
| 6 | `pynn/core/__init__.py` |
| 6 | `pynn/nn/activations.py` |
| 6 | `pynn/nn/losses.py` |
| 6 | `pynn/verify/gradients.py` |
